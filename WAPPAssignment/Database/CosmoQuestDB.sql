...
-- Create Database
IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'CosmoQuestDB')
BEGIN
    CREATE DATABASE CosmoQuestDB;
END
GO
...
CREATE TABLE Users (
    ...
    Role NVARCHAR(20) NOT NULL DEFAULT 'Member', -- Guest, Member, Admin
...
CREATE TABLE Planets (
    ...
    DistanceFromSun DECIMAL(18,2), -- in million km
    Diameter DECIMAL(18,2), -- in km
    Mass DECIMAL(18,2), -- relative to Earth
    OrbitalPeriod DECIMAL(18,2), -- in Earth days
    RotationPeriod DECIMAL(18,2), -- in hours
    Moons INT,
...
CREATE TABLE StarsGalaxies (
    ...
    Type NVARCHAR(50), -- Star, Galaxy, Nebula, etc.
    Description NVARCHAR(MAX),
    Distance DECIMAL(18,2), -- in light years
    Mass NVARCHAR(100),
...
CREATE TABLE Quizzes (
    ...
    Description NVARCHAR(MAX),
    Category NVARCHAR(50), -- Solar System, Stars, Missions, etc.
...
CREATE TABLE QuizQuestions (
    ...
    QuestionType NVARCHAR(20), -- Multiple Choice, True/False
    OptionA NVARCHAR(255),
    OptionB NVARCHAR(255),
    OptionC NVARCHAR(255),
    OptionD NVARCHAR(255),
    CorrectAnswer NVARCHAR(10), -- A, B, C, D, or True/False
...
-- Insert Sample Stars and Galaxies
...
PRINT 'CosmoQuest Database created successfully!';
GO
